...
public enum DragSupport {
  ...
  private abstract static class BaseDrag<T> extends WeakReference<T> implements DragHandle {
  ...
  private static final EventHandler<MouseEvent> press = e -> Optional.ofNullable(map.get(e.getSource()))
      .ifPresent(d -> d.press(e));
  private static final EventHandler<MouseEvent> drag = e -> Optional.ofNullable(map.get(e.getSource())).ifPresent(d -> d.drag(e));
  private static final EventHandler<MouseEvent> release = e -> Optional.ofNullable(map.get(e.getSource()))
      .ifPresent(d -> d.release(e));
}
